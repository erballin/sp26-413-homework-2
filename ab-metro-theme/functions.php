<!-- = REQUIREMENTS = 
functions.php — must enqueue the stylesheet using wp_enqueue_style(), enable title-tag, post-thumbnails, and custom-logo via add_theme_support(), and register a navigation menu using register_nav_menus()
-->
